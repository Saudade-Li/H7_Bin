...
//  LCD_ShowNum(48,4,x,3,12);
//  LCD_ShowChar(24,2,'L',12,0);
//  LCD_ShowString(4, 4, ST7735Ctx.Width, 16, 16, "li");
//  LCD_ShowString()
//  sprintf(&data,x);
//  sprintf((char *)&text,"LCD num = %f",data);
////  sprintf((char *)&text, "WeAct Studio");
//  LCD_ShowString(4, 4, ST7735Ctx.Width, 16, 16, text);
//  LCD_ShowString(4, 4, ST7735Ctx.Width, 16, 16, &data);
